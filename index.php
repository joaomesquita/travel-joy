    ...
    <div class="container">
        <div class="alert alert-primary">
            <div class="row align-items-center">
                <div class="col-md-10">
                    <h3>Gostaria de conhecer o Camboja?</h3>
                    <p>Baixe Grátis nosso roteiro. Guia incrível para bares, restaurantes, hotéis e passeios.</p>
                </div>
                <hr class="hidden-lg hidden-md space">
                <div class="col-md-2">
                    <a href="#" class="btn btn-lg btn-outline-primary">Baixe o Roteiro</a>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-5">
            <div class="col-md-12">
                <h2 class="title">A Ocasião faz o destino</h2>
